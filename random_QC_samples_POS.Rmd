...
## Define paths:
filename <- "random_QC_samples_POS"
...
ts <- extract_time_stamp(fileNames(data_pos))
...
injections <- as.data.frame(read_xlsx("QC-2016-2021_05_QC3-6-9_POS.xlsx"))
pd_pos <- injections
```
...
labs <- unique(data_pos$year_month)
...
boxplot(lapply(bpchr, function(z) log2(intensity(z))), outline = FALSE,
        ...
        main = "QC samples, positive polarity",names = chr$year_month,
...
## analysis
std_info$rtmin[std_info$name == "3-Nitrotyrosine"] <- 138
std_info$rtmax[std_info$name == "3-Nitrotyrosine"] <- 170
std_info$rtmin[std_info$name == "Acetylhistidine"] <- 165
std_info$rtmax[std_info$name == "Acetylhistidine"] <- 190
std_info$rtmin[std_info$name == "ADMA"] <- 163
std_info$rtmax[std_info$name == "ADMA"] <- 198
std_info$rtmin[std_info$name == "alpha-Aminoadipic acid"] <- 162
std_info$rtmax[std_info$name == "alpha-Aminoadipic acid"] <- 200
...
std_info$rtmin[std_info$name == "Argininosuccinic acid"] <- 185
std_info$rtmax[std_info$name == "Argininosuccinic acid"] <- 205
std_info$rtmin[std_info$name == "Asparagine"] <- 178
std_info$rtmax[std_info$name == "Asparagine"] <- 295
std_info$rtmin[std_info$name == "Caffeine"] <- 30
std_info$rtmax[std_info$name == "Caffeine"] <- 40
std_info$rtmin[std_info$name == "Citrulline"] <- 170
std_info$rtmax[std_info$name == "Citrulline"] <- 210
std_info$rtmin[std_info$name == "Corticosterone"] <- 22
std_info$rtmax[std_info$name == "Corticosterone"] <- 45
std_info$rtmin[std_info$name == "Creatine"] <- 158
std_info$rtmax[std_info$name == "Creatine"] <- 185
...
std_info$rtmin[std_info$name == "Dimethylglycine"] <- 160
std_info$rtmax[std_info$name == "Dimethylglycine"] <- 175
...
std_info$rtmax[std_info$name == "Glycine"] <- 185
std_info$rtmin[std_info$name == "Histidine"] <- 170
std_info$rtmax[std_info$name == "Histidine"] <- 210
std_info$rtmin[std_info$name == "Homocysteine"] <- 160
std_info$rtmax[std_info$name == "Homocysteine"] <- 180
std_info$rtmin[std_info$name == "Hydroxyproline"] <- 160
std_info$rtmax[std_info$name == "Hydroxyproline"] <- 180
std_info$rtmin[std_info$name == "Indoleacetic acid"] <- 32
std_info$rtmax[std_info$name == "Indoleacetic acid"] <- 40
std_info$rtmin[std_info$name == "Inosine"] <- 130
std_info$rtmax[std_info$name == "Inosine"] <- 155
std_info$rtmin[std_info$name == "L-Aspartic Acid"] <- 172
...
std_info$rtmin[std_info$name == "Palmitoylcarnitine"] <- 20
std_info$rtmax[std_info$name == "Palmitoylcarnitine"] <- 43
std_info$rtmin[std_info$name == "Phenylalanine"] <- 135
std_info$rtmax[std_info$name == "Phenylalanine"] <- 170
std_info$rtmin[std_info$name == "Putrescine"] <- 150
std_info$rtmax[std_info$name == "Putrescine"] <- 173
...
std_info$rtmin[std_info$name == "Suberic Acid"] <- 28
std_info$rtmax[std_info$name == "Suberic Acid"] <- 45
std_info$rtmin[std_info$name == "Taurine"] <- 160
std_info$rtmax[std_info$name == "Taurine"] <- 180
std_info$rtmin[std_info$name == "Threonic Acid"] <- 100
std_info$rtmax[std_info$name == "Threonic Acid"] <- 140
