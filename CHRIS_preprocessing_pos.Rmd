...
lapply(chris_batch, function(z) {
    ...
    dr <- file.path("images", "standards_all_eics", sampleData(z)$batch_id[1L])
...
#' Based on these EICs the data/standatds_chris_pos_batch.txt file should be
...
```{r reorder_data_set}
## jo: I would remove the re-ordering of the code since we don't need it - and will confuse us
