...
#' Injection index
col_injection_index <- rainbow(length(unique(res$injection_index)))
...
```{r PCA-before-norm, fig.path = IMAGE_PATH, fig.height=7, fig.width=8}
# With imputation
...
```{r is-before-norm, fig.path = IMAGE_PATH, fig.height=7, fig.width=8}
#' get the list
