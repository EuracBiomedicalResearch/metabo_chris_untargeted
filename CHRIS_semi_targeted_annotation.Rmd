...
#load(file.path(DATA_PATH, "SumExp_chris_norm.RData")) #res is object, crashed when loading locally and on server
load(file.path(DATA_PATH, "SumExp_chris_filtered_norm.RData")) #res is object NOT USE, found stds are in the removed FTs (of 3820#)!!! #' discarded were "Creatinine" [bad] and "Serotonin" [good] (from p180). BUT also killed...
